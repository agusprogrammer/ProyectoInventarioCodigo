...
namespace dam.di.inventario.clase.Modelo
{
    ...
    public partial class articulo : MVBase
    {
        ...
        [Required] //Estado, requerido por programa 
        public string estado { get; set; }
        [Required] //Fecha de alta, requerida por programa
        ...
        [Required] //Espacio1 (el objeto no la variable), requerido not null base de datos
        public virtual espacio espacio1 { get; set; }
        [Required] //Modelo de articulo, requerido not null base de datos
        public virtual modeloarticulo modeloarticulo { get; set; }
        [Required] //Usuario de alta requerido por programa
